...
const ThankYou = ({route,navigation}) => {
     const {booking_id,date,time,phone} = route.params;
     ...
     return (
        ...
        <View style={styles.card}>
            <View style={styles.row}>
                <Text style={styles.head}>{i18n.t('booking_id', { locale: lang })}</Text>
                <Text style={styles.subhead}>{booking_id}</Text>
            </View>
            <View style={styles.row}>
                <Text style={styles.head}>{i18n.t('date', { locale: lang })}</Text>
                <Text style={styles.subhead}>{date.substring(0,10)}</Text>
            </View> 
            <View style={styles.row}>
                <Text style={styles.head}>{i18n.t('time', { locale: lang })}</Text>
                <Text style={styles.subhead}>{time}</Text>
            </View>
            <View style={styles.row}>
                <Text style={styles.head}>{i18n.t('phone', { locale: lang })}</Text>
