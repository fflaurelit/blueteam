...
const Cpayment2 = ({navigation,route}) => {
   ...
   useEffect(() => {
    ...
    function initiatePayments() {
        setLoading(true)
        let initiateRequest = new MFInitiatePayment(1200, MFCurrencyISO.UAE_AED)
        ...
        function executeResquestJson(id) {
                setLoading(true)
        let request = new MFExecutePaymentRequest(1200, id);
